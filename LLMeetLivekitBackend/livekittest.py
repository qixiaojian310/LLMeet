...
async def main(room: rtc.Room) -> None:
    ...
    token = (
        api.AccessToken("apiKey","dsauihdo2faskljhnfiosahjfoiaf5fi87568968guivsho98dh92wq8dhdj1908rujfsafawd90j")
        .with_identity("python-bot2")
        .with_name("Python Bot2")
        .with_grants(
            api.VideoGrants(
                room_join=True,
                room="my-room",
    ...
    await room.connect("wss://hkucompcs.xyz:4431", token)
